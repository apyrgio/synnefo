...
class Volume(models.Model):
    ...
    # This field will be used only for pre 0.4.1 Archipelago volumes, since
    ...
    # detachable volumes.
    #
    # FIXME: Determine which is the first Archipelago version that uses
    # Synnefo's canonical name
